...
<UnimplementedModal href="https://gitlab.com/groups/sway-me/mobile/-/boards"/>

<div className="mobile" />
<blockquote style={{fontSize:12}}>
    Mobile icon set. Can be set to trigger to dark/light mode at dusk/dawn respectively.
</blockquote>

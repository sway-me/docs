...
<UnimplementedModal href="https://gitlab.com/sway-me/workstation/-/boards"/>

<div className="workstation" />
<blockquote style={{fontSize: 14}}>
    Sway Rice with personal services dashboard.
</blockquote>

Sway workstation  are packages and dotfiles is to provide streamlined work environment. This configuration will be most useful to those whom code full time.

This will install two types of dotfiles.

- The first are [rice](https://reddit.com/r/unixporn) dotfiles that follows the styles in the core sway [ui kit](https://github.com/sway-me/shared/ui-kit).
...
In order to continue, Arch Linux should be a in bootable state with working network connection and yay installed. This means you should boot into the prompt and you should be able to do a system upgrade with `yay -Syu`.

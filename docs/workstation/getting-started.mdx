...
In order to continue, Arch Linux should be a in bootable state with working network connection and yay installed. This means you should be able to ping google and upgrade yay packaged with `yay -Syu`.
